...
class CIteratorBase
    :public baseex::core::TIterator<baseex::core::IStreamBuffer::Ptr>
{
public:
    ...
    virtual baseex::core::IStreamBuffer::Ptr current() override
    {
...
baseex::core::TIterator<baseex::core::IStreamBuffer::Ptr>::Ptr CreateBaseIterator(baseex::core::IStream::Ptr aStream, const char aDelimeter)
{
    return baseex::core::TIterator<baseex::core::IStreamBuffer::Ptr>::Ptr(new CIteratorBase(aStream, aDelimeter));
}
