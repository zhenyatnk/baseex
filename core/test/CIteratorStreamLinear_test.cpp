...
TEST_F(CIteratorStreamLinear_test, empty_source)
{
    std::string buffer = "";
...
TEST_F(CIteratorStreamLinear_test, non_empty_source)
{
    std::string buffer = "1";
    auto iterator = baseex::core::CreateLinearBuffer(buffer.c_str(), buffer.size())->CreateIterator();
...
TEST_F(CIteratorStreamLinear_test, size_elements_1)
{
    std::string buffer = "1";
    auto iterator = baseex::core::CreateLinearBuffer(buffer.c_str(), buffer.size())->CreateIterator();
...
TEST_F(CIteratorStreamLinear_test, size_elements_2)
{
...
TEST_F(CIteratorStreamLinear_test, some_elements)
{
...
TEST_F(CIteratorStreamLinear_test, throw_out_of_range)
{
    std::string buffer = "1";
    auto iterator = baseex::core::CreateLinearBuffer(buffer.c_str(), buffer.size())->CreateIterator();
    ASSERT_EQ(true, iterator.next());
