...
TEST_F(StreamBuffer_test_stage_0, size)
{
    ...
    baseex::core::IStream::Ptr lStream = baseex::core::CreateStreamBuffer(lNominal.c_str(), lNominal.size());
...
{
    std::string lNominal = "test1 test2";
    baseex::core::IStream::Ptr lNominalStream = baseex::core::CreateStreamBuffer(lNominal.c_str(), lNominal.size());
    baseex::core::IStream::Ptr lResultStream = lNominalStream->Read(0, lNominalStream->Size());
...
TEST_F(StreamBuffer_test_stage_0, read_stream_size_part)
{
    std::string lNominal = "test1 test2";
    baseex::core::IStream::Ptr lNominalStream = baseex::core::CreateStreamBuffer(lNominal.c_str(), lNominal.size());
    baseex::core::IStream::Ptr lResultStream = lNominalStream->Read(0, 5);
...
TEST_F(StreamBuffer_test_stage_0, read_stream_data_first_part)
{
    ...
    baseex::core::IStream::Ptr lNominalStream = baseex::core::CreateStreamBuffer(lNominal.c_str(), lNominal.size());
    baseex::core::IStream::Ptr lResultStream = lNominalStream->Read(0, lNominalPart.size());
...
TEST_F(StreamBuffer_test_stage_0, read_stream_data_second_part)
{
    ...
    baseex::core::IStream::Ptr lNominalStream = baseex::core::CreateStreamBuffer(lNominal.c_str(), lNominal.size());
    baseex::core::IStream::Ptr lResultStream = lNominalStream->Read(lNominalPart.size(), lSecondPartSize);
...
TEST_F(StreamBuffer_test_stage_0, read_stream_data_big_size)
{
    ...
    baseex::core::IStream::Ptr lNominalStream = baseex::core::CreateStreamBuffer(lNominal.c_str(), lNominal.size());
    baseex::core::IStream::Ptr lResultStream = lNominalStream->Read(lNominalPart.size(), 1024);
...
TEST_F(StreamBuffer_test_stage_0, write_linear_stream_write)
{
    ...
    baseex::core::ILinearWriteStream::Ptr lStreamWrite = baseex::core::CreateLinearWriteBuffer(lPart1.size() + lPart1.size());
